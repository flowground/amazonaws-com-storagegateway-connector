# ![LOGO](logo.png) AWS Storage Gateway MSP Connector

## Description

A generated MSP connector for the AWS Storage Gateway API (version 2013-06-30).
...
flowground :- Telekom iPaaS / amazonaws-com-storagegateway-connector<br/>
